@extends('layouts.app')
@section('title', __('lang_v1.edit_balance'))

@section('content')
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('lang_v1.edit_balance')</h1>
</section>

<!-- Main content -->
<section class="content">
    {!! Form::open(['url' => action([\App\Http\Controllers\BalanceController::class, 'update'], [$balance->id]), 'method' => 'PUT', 'id' => 'balance_edit_form' ]) !!}
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('date', @format_date($balance->date), ['class' => 'form-control', 'required', 'placeholder' => __('messages.date'), 'id' => 'date']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('location_id', $business_locations, $balance->location_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']) !!}
                        </div>
                    </div>
                </div>

                <div id="raw_materials">
                    @foreach($balance->product_id as $key => $product_id)
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::number('raw_material[]', $balance->raw_material[$key], ['class' => 'form-control raw_material', 'required', 'placeholder' => __('lang_v1.raw_material')]) !!}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    @if($key > 0)
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('total_quantity', $balance->total_quantity, ['class' => 'form-control', 'readonly', 'id' => 'total_quantity']) !!}
                        </div>
                    </div>
                </div>
            @endcomponent
...
$(document).ready(function() {
        ...
        if (productId) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    updateRemainingStock(stockSpan, quantityInput, currentStock);
                },
                error: function() {
    ...
    function updateRemainingStock(stockSpan, quantityInput, currentStock) {
        ...
        stockSpan.html('Current Stock: ' + remainingStock.toFixed(2));
    ...
    $('#balance_edit_form').on('submit', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(response) {
                if(response.success) {
                    ...
                    window.location.href = '{{ action([\App\Http\Controllers\BalanceController::class, 'index']) }}';
                } else {
