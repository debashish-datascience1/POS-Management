...
<section class="content-header">
	<h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('purchase.add_purchase') <i
			...
			data-placement="bottom" data-content="@include('purchase.partials.keyboard_shortcuts_details')"
			data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
</section>
...
<section class="content">
	...
	{!! Form::open(['url' => action([\App\Http\Controllers\PurchaseController::class, 'store']), 'method' => 'post',
	'id' => 'add_purchase_form', 'files' => true ]) !!}
	...
	<div class="row">
		...
		<div class="col-sm-3 @if(!empty($default_purchase_status)) hide @endif">
			<div class="form-group">
				...
				{!! Form::select('status', $orderStatuses, $default_purchase_status, ['class' => 'form-control select2',
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				select2', 'placeholder' => __('messages.please_select'), 'required'], $bl_attributes); !!}
			</div>
		</div>
		...
		<div class="col-sm-3 @if(!$currency_details->purchase_in_diff_currency) hide @endif">
			<div class="form-group">
				...
				<div class="input-group">
					...
					{!! Form::number('exchange_rate', $currency_details->p_exchange_rate, ['class' => 'form-control',
					'required', 'step' => 0.001]); !!}
				</div>
		...
		<div class="col-md-3">
			<div class="form-group">
				<div class="multi-input">
					...
					<br />
					{!! Form::number('pay_term_number', null, ['class' => 'form-control width-40 pull-left', 'min' => 0,
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				{!! Form::file('document', ['id' => 'upload_document', 'accept' => implode(',',
	...
	<div class="row">
		<div class="col-sm-3">
			<div class="form-group">
				...
				{!! Form::select('purchase_order_ids[]', [], null, ['class' => 'form-control select2', 'multiple', 'id'
				=> 'purchase_order_ids']); !!}
			</div>
		</div>
	</div>
				...
				<table class="table table-condensed table-bordered table-th-green text-center table-striped"
					...
					<thead>
						<tr>
							...
							@endif
							<th>@lang('lang_v1.gst')</th> <!-- Added GST column -->
